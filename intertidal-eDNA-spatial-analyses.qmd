...
Some packages require installation from Bioconductor using the `BiocManager::install()` command or directly from GitHub.
...
packages <- c("devtools",
              ...
              "ggforce",
              "phyloseq",
              "ANCOMBC", #bioc install
              "DT",
              "ranacapa", #for ggrare, github download
              "plyr",
              "reshape2",
              "patchwork",
              "microViz",
              "microeco",
              "eulerr",
              "microbiomeutilities", #github install
              "ggtreeExtra", #bioc install
              "mgcv",
              "cowplot",
              "geosphere",
              "MiscMetabar",
...
#response
ggplot(diversity_meta, aes(x=sqrt(Observed))) + geom_histogram()
ggplot(diversity_meta, aes(x=Shannon)) + geom_histogram()

#predictors
ggplot(diversity_meta, aes(x=averageTemp)) + geom_histogram()
ggplot(diversity_meta, aes(x=averagePH)) + geom_histogram()
```
